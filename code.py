...
def face_recog(bottom_model, num_classes):
...
FC_Head = face_recog(MobileNet, num_classes)
...
face_recognition_dict = {"[0]": "prasanth", 
                      "[1]": "acna",
                      "[2]": "dca"}

face_recognition_dict_n = {"0": "prasanth", 
                      "1": "acna",
                      "2": "dca"}
...
"""This can be used for testing the images from the test dataset.."""
